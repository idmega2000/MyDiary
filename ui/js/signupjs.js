...
const signupValidation = () => {
  ...
  const input_email = document.getElementById('emailInp').value;
  const input_password = document.getElementById('passInp').value;
  const input_repeat_password = document.getElementById('repeatPassInp').value;
